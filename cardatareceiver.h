...
signals:
    void carlaJsonDataParsed(int speed,QString alart,int autoPilotFlag, QString AGear,int leftSignal,int rightSignal,bool warning,bool handBrake, QString trafficSign,bool highBeam, bool adaptiveLight, bool drowsinessDetection, int RPM, double fuelLevel);
